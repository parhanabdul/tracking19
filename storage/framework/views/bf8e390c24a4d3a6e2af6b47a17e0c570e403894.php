          ...
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li><a href="#mencengah" class="nav-link">Pencegahan</a></li>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 mr-auto text-center text-lg-left">
            ...
            <p class="mb-5"> Sehat itu bukan suatu kemewahan. Sehat itu murah, tetapi menjadi mahal ketika sehat telah berubah menjadi sakit.</p>
        ...
        <div class="row"> 
          <div class="col-lg-3">
            <div class="data">
              ...
              <strong class="d-block number"><?php echo e($positif); ?></strong>
          ...
          <div class="col-lg-3">
            <div class="data">
              ...
              <strong class="d-block number"><?php echo e($meninggal); ?></strong>
          ...
          <div class="col-lg-3">
            <div class="data">
              ...
              <strong class="d-block number"><?php echo e($sembuh); ?></strong>
          ...
          <div class="col-lg-7 text-center mx-auto">
            ...
            <div class="table-wrapper-scroll-y my-custom-scrollbar col-lg-12">
                ...
                <table class="table table-bordered table-string mb-0" with="100%">
                    ...
                    <?php $__currentLoopData = $lokal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <th scope="row"><center><?php echo e($no++); ?></center>
                        <td><center><?php echo e($data->nama_provinsi); ?></center></td>
                        <td><center><?php echo e(number_format($data->jumlah_positif)); ?></center></td>
                        <td><center><?php echo e(number_format($data->jumlah_meninggal)); ?></center></td>
                        <td><center><?php echo e(number_format($data->jumlah_sembuh)); ?></center></td>
                        </th>
                    </tr>   
        ...
        <div class="row content" data-aos="fade-up">
            ...
            <div class="table-wrapper-scroll-y my-custom-scrollbar col-lg-12">
              ...
              ?>
                ...
                <?php $__currentLoopData = $globall; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      <td> <?php echo $no++ ?></td>
...
<?php /**PATH C:\xampp\htdocs\prakerinasli\resources\views/frontand/welcome.blade.php ENDPATH**/ ?>