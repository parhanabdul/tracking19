            ...
            <?php if(Route::has('login')): ?>
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(url('/welcome')); ?>" class="text-sm text-gray-700 underline">WELCOME</a>
                    <?php else: ?>
...
<?php /**PATH C:\xampp\htdocs\prakerinasli\resources\views//halamanutama.blade.php ENDPATH**/ ?>